...
const animalData = [
  { name: 'Reggie', bio: 'I am a dog', sex: 'Male', species: 'Dog', breed: ['Greyhound', 'Whippet'], age: 5, colour: [ 'Brown', 'White'], imgUrl: 'https://imgur.com/bDBMlEA', location: 'B91 1NW', owner: userId[0], goodBad: [5, 5, 5, 5, 5] }
