...
const animalData = [
  ...
  { name: 'Charlie', bio: 'I am also a dog', sex: 'Male', species: 'Dog', breed: ['Lurcher'], age: 3, colour: [ 'Brown'], imgUrl: '', location: 'B91 1NW', owner: userId[0], goodBad: [1, 1, 1, 1, 1], availableOn: [] },
